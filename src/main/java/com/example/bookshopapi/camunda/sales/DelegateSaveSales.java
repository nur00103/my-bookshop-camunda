...
@Component("delegateSaveSales")
public class DelegateSaveSales implements JavaDelegate {

    private final SalesService salesService;

    public DelegateSaveSales(SalesService salesService) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        delegateExecution.setVariable("postSales",salesService.saveSales(salesRequest));
    }
}
