...
@Component("delegateCheckCustomerData")
public class DelegateCheckCustomerData implements JavaDelegate {
    private final SalesService salesService;

    public DelegateCheckCustomerData(SalesService salesService) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        delegateExecution.setVariable("checkCustomerData",salesService.checkCustomer(salesRequest));
    }
}
