...
@Component("delegateCheckBookData")
public class DelegateCheckBookData implements JavaDelegate {
    private final SalesService salesService;

    public DelegateCheckBookData(SalesService salesService) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        delegateExecution.setVariable("checkBookData",salesService.checkBook(salesRequest));
    }
}
